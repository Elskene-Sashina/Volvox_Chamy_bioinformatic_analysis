...
### 📊 Сравнение с другими организмами (pure Volvox-specific)

| Категория | Количество | % |
|-----------|------------|---|
| **Всего генов** | 629 | 100.0 |
| Гены с Best-hit в **Arabidopsis** | 3 | 0.5 |
| Гены с Best-hit в **Rice** | 8 | 1.3 |
| **Без хитов в растениях** | **619** | **98.4** |

> 💡 **Интерпретация**: Почти ВСЕ (98.4%) pure Volvox-specific гены — это **de novo** гены или сильно дивергировавшие!
