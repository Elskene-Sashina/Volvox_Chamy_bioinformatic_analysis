...
**Temporal Coaptation Hypothesis**: Многоклеточность у *Volvox carteri* эволюционировала через **перенос временных программ** *Chlamydomonas* (день/ночь) в **пространственные программы** (2 типа клеток - germ \ soma).
...
**Гипотеза**:  
Эволюция произошла через **некодирующие белки регуляторные элементы** (промоторов, энхансеров, некодирующих\структурных РНК и тд),  **а не через эволюцию белок-кодирующих генов**.
