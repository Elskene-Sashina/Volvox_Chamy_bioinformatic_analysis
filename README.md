...
1) разработать системы культивирования с фиксированием изменяемых переменных культуры (температура / ph / уровень CO2 / свет - с помощью Arduino + Rasberry PY)
2) выделение 2ух ферментов Вольвокса разрушающих ECM - главная преграда для выделения ядер
3) перенос и адаптация протокола выделения интактных ядер с Хламидомонады на Вольвокс для последующего single nucleus RNA seq
